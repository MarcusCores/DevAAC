...
__Check out the [REST API documentation](http://TheDevOne.github.io/DevAAC)!__
...
=====
* Download zip-bundle release from [GitHub](https://github.com/TheDevOne/DevAAC/releases) (green button)
* Unpack to a directory higher than your web root, so that public_html is the web root (you can rename it if you need)
* If you use nginx, you can find sample vhost config [in our wiki](https://github.com/TheDevOne/DevAAC/wiki)
...
* Clone this repo: ```git clone https://github.com/TheDevOne/DevAAC.git```
* Install dependencies: ```composer.phar install```
* Set up your web server to serve DevAAC/public_html as document root and add [required rewrites](https://github.com/TheDevOne/DevAAC/wiki)
